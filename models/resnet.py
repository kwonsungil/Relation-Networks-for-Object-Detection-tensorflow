...
if __name__ == '__main__':
    ...
    # inputs = tf.placeholder(tf.float32, shape = [1, 1000, 586, 3])
    with slim.arg_scope(resnet_arg_scope()):
        net = resnet_v2_101(inputs, is_training=False)
        sess = tf.Session()
        saver = tf.train.Saver()
        saver.restore(sess, 'F:\\kwon\\Faster-rcnn-tensorflow-master\\model_pretrained\\resnet_v2_101.ckpt')