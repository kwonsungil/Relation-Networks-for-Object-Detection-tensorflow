...
PASCAL_PATH = 'F:/kwon/Faster-rcnn-tensorflow-master/dataset'
...
# OUTPUT_DIR = os.path.join('output_baseline')
OUTPUT_DIR = os.path.join('output_relation')
...
vgg_weight_path = os.path.join('model_pretrained', 'vgg_16.ckpt')
resnet_weight_path = os.path.join('model_pretrained', 'resnet_v2_101.ckpt')
